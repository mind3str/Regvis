...
const taxonomy = {
    ...
    Conference: ["IEEE VIS/TVCG","IEEE PacificVis","Journal of Banking and Financial Technology ","Arxiv","Decision Support Systems","EUROGRAPHICS","EuroVis","International Conference on Availability,Reliability and Security","Journal of financial stability","Big data concepts, theories, and applications(Book)","VAST","Managerial Auditing Journal","VizSec","SA'15 Symposium on VisHPC","IEEE VIS","Mapping Financial Stability(Book)","DNB Working Paper","iConference","IEEE Conference on Computational Intelligence for Financial Engineering &Economics","International Federation for Information Processing","information sciences","IVAPP","Conference on Data Standards,Information,and Financial Stability","Expert Systems with Applications","ICT Systems Security and Privacy Protection","Engineering Applications of Artificial Intelligence","Neurocomputing","International Conference on Information Visualisation","IEEE International Conference on Intelligence and Security Informatics","Financial Analysis and Risk Management","Tsinghua Science and Technology","IVAPP 2012 - International Conference on Information Visualization Theory and Applications","Hawaii International Conference on System Sciences","IEEE SIGNAL PROCESSING MAGAZINE","VINCI - International Symposium on Visual Information Communication and Interaction","International UKVAC Workshop on Visual Analytics","International Workshop on Self-Organizing Maps","IEEE Symposium on Computational Intelligence for Financial Engineering and Economics","Procedia Computer Science","VINCI","Conference on Visualization and Data Analysis","KICSS - International Conference on Knowledge, Information and Creativity Support Systems","International Conference on Industrial, Engineering and Other Applications of Applied Intelligent Systems","ACM SIGKDD Explorations Newsletter","Financial Stability Report","IEEE Symposium on Information Visualization","Journal of Visualization","AI Magazine","Proceedings Visualization","University of Toronto","CHI - ACM Conference on Human Factors in Computing Systems","CG&A - IEEE Computer Graphics and Applications Magazine","IEEE Visualization Conference","Institute for Systems Research Technical Reports"],
